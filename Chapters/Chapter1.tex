...
In the last section of this chapter we settle the bases to understand rigidity within a Graph theory context. An approach called \textit{rigid expansions}, see \cite[Aramayona 16]{finiteRigidSetsJA} and \cite[Hernandez 16]{exhaustionCurveGraph}, allows us to build up subgraphs preserving the rigidity property and is compatible with a stochastic scheme.
