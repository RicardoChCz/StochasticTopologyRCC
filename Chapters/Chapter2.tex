...
For these calculations we calculated the empiric probability by repeating this experiment 500 times and counting the number of times that the random set uniquely determine the $n$-th vertex.
