...
\chapter{Rigidity in graphs from the random viewpoint} % Main chapter title

\label{Chapter2} % For referencing the chapter elsewhere, use \ref{Chapter1} 

\lhead{Chapter 2. \emph{Rigidity in graphs from the random viewpoint}} % This is for the header on each page - perhaps a shortened title
