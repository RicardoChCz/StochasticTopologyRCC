...
\begin{abstract}
The study of rigidity in the curve complex borns from the desire to describe morphisms between mapping class groups of surfaces using the information of the underlying surfaces. We propose the use of random topology to provide a probabilistic insight using the combinatorial traduction of the matter.
