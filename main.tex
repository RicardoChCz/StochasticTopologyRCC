...
We propose the use of random topology to study rigidity and rigid expansions in graphs. The goal is to do it in the curve graph associated to a surface $S$, we will show the conditions under which is possible to do it in a simple probabilistic model.
