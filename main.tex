...
\newcommand{\ESim}{\mathrlap{\nearrow}^{s} \ }
\newcommand{\CSim}{\mathrlap{\searrow}^{\ s} \ }
\newcommand{\EElem}{\mathrlap{\nearrow}^{e} \ }
\newcommand{\CElem}{\mathrlap{\searrow}^{\ e} \ }
\newcommand{\SimpHomEq}{\mathrlap{\hspace{0.10cm}\ssearrow}/\hspace{0.15cm}}
\newcommand{\RFD}{\selsquigarrow}
\newcommand{\cl}{\tilde{L}}
\newcommand{\cel}{e_{\alpha}}
\newcommand{\gfk}{\pi_{1}(K)}
\newcommand{\gfky}{\pi_{1}(K, y)}
\newcommand{\Ckglg}{C(\tilde{K}, \tilde{L})}
\newcommand{\CKgLg}{C(\tilde{K}, \tilde{L})}
\newcommand{\CLgMg}{C(\tilde{L}, \tilde{M})}
\newcommand{\CKgMg}{C(\tilde{K}, \tilde{M})}
...
\newcommand{\xg}{\tilde{x}}
\newcommand{\ck}{\tilde{K}}
\newcommand{\gfxx}{\pi_{1}(X, x)}
\newcommand{\gfkx}{\pi_{1}(K, x)}
\newcommand{\wvb}{\widehat{\varphi{\beta}}}
\newcommand{\wva}{\widehat{\varphi{\alpha}}}
\newcommand{\tva}{\tilde{\varphi{\alpha}}}
\newcommand{\Xg}{\tilde{X}}
\newcommand{\kg}{\tilde{K}}
\newcommand{\ii}{i_{*}}
\newcommand{\ji}{j_{*}}
...
%\begin{flushright}
%\textit{
%Que nuestra voz no desmaye\\
%y que cante sin cesar\\
%que el corazón nunca calle,\\
...
\begin{abstract}
The study of rigidity in the curve complex borns from the desire to describe  morphisms between mapping class groups of surfaces using the information of the underlaying surfaces. We propose the use of random topology to provide tractable toy models using the translation of the subject into a combinatorial language 
