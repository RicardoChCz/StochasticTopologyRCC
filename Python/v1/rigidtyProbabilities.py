...
from rigidity import singleVerification
...
def setOfExperiments(N,P,evento):
    ...
    if evento == 1:
        plt.savefig('Uniquely-determinated-fixed-vertex.png')
    elif evento == 2:
        plt.savefig('Uniquely-determinated-any-vertex.png')
    else:
        plt.savefig('Expansion-probability.png')
...
def individualExperiments(n,p,evento):
    ...
    if evento == 1:
        plt.savefig('Single-uniquely-determinated-fixed-vertex.png')
    elif evento == 2:
        plt.savefig('Single-uniquely-determinated-any-vertex.png')
    else:
        plt.savefig('Single-expansion-probability.png')
